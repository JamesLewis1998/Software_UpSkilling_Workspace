...
def is_adult(age): 
    if age >  18:
        ...
        return False
# Instead of writing like this we can implement it with a Ternary Operator 

def is_adult2(age): 
    return True if age > 18 else False
    # first define result if condition is true, then evaluate the condition

# Note Functions in python are objects.
# If you want to print the value returned by the function, you need to call the function and print out the return value:
print(is_adult(14))
print(is_adult2(14))
