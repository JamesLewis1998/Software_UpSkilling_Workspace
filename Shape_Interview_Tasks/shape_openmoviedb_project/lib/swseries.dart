...
class StarwarsSeries extends StatefulWidget {
  const StarwarsSeries({super.key});
  @override
  State<StarwarsSeries> createState() => _StarwarsSeriesState();
}

class _StarwarsSeriesState extends State<StarwarsSeries> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Starwars Series'),
